...
in {
  ...
  config = mkIf cfg.enable {
    ...
    users.groups.vodafone-station-exporter = mkIf (cfg.group == "vodafone-station-exporter") {};
    ...
    systemd.services.prometheus-vodafone-station-exporter = {
      ...
      script = ''
        ${pkgs.prometheus-vodafone-station-exporter}/bin/vodafone-station-exporter \
